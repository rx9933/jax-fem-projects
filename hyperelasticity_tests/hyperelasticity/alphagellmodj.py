...
class HyperElasticity(Problem):
    ...
    def get_tensor_map_spatial_var(self):
        ...
        def psi(F, X):
            ...
            nu = 0.49 
            alpha = get_alpha(X) # X is current location/point
...
def problem():
    ...
    for i in range(num_cells):
        for j in range(num_points):
            ...
            point_val = points[global_pointind] # 1d, len 3 array of a single point (current location, X
