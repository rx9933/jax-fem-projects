...
def problem():
    ...
    #TESTS
    # print("aa",cell_surface(np.array([8.254631805419921875e+01, 8.463780975341796875e+01, 2.081762695312500000e+01])))
    ...
    vtk_path = os.path.join(data_dir, f'vtk/test_alpha.vtu')
