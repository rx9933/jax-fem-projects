...
def problem():
    ...
    ###
    # n = plt.hist(local_alpha)
    # plt.savefig("jaxalpha.png")
    # print("N",n)

    # u_curr = sol[0]
    # n = plt.hist(u_curr[0])
    # plt.savefig("jaxux.png")
    # print("Nux",n)
    
    # u_curr = sol[0]
    # n = plt.hist(u_curr[1])
    # plt.savefig("jaxuy.png")
    # print("Nuy",n)

    # u_curr = sol[0]
    # n = plt.hist(u_curr[2])
    # plt.savefig("jaxuz.png")
    # print("Nuz",n)

    u_curr = sol[0]
    n = plt.hist(np.linalg.norm(u_curr, axis=1),bins=20)
    plt.savefig("jaxum.png")
    print("Num",n)
    
    norms = np.linalg.norm(u_curr, axis=1)

    # Count how many values are greater than 0.4
